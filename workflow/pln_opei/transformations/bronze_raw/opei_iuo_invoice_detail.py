from data_validation_framework.schema.set.opei.opei_iuo_invoice_detail import schema
...
register_bronze_raw_table(
    spark,
    BronzeRawTableSpec(OPEI_IUO_INVOICE_DETAIL, OPEI_IUO_INVOICE_DETAIL_CDC, schema),
)
